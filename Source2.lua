...
local tutorialkey_UICorner = Instance.new("UICorner")
local tutorialkeyStroke = Instance.new("UIStroke")
local tutorialKeyPadding = Instance.new("UIPadding")
...
containerbutton.Size = UDim2.new(0.800000012, 0, 0, 95)
...
function chaoshubmodule.FunctionGetKeyButton(callback)
...
local tutorialkey = Instance.new("TextButton")
tutorialkey.Name = "tutorial key"
tutorialkey.Parent = containermain
tutorialkey.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
tutorialkey.BackgroundTransparency = 0.650
tutorialkey.BorderColor3 = Color3.fromRGB(0, 0, 0)
tutorialkey.BorderSizePixel = 0
tutorialkey.Position = UDim2.new(0.0982423201, 0, 0.300925791, 0)
tutorialkey.Size = UDim2.new(0.200000003, 0, 0.100000001, 0)
tutorialkey.Font = Enum.Font.Unknown
tutorialkey.FontFace = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Bold)
tutorialkey.Text = "Tutorial key"
tutorialkey.TextColor3 = Color3.fromRGB(255, 255, 255)
tutorialkey.TextScaled = true
tutorialkey.TextSize = 14.000
tutorialkey.TextWrapped = true

tutorialkeyStroke.Thickness = 2
tutorialkeyStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
tutorialkeyStroke.Color = Color3.fromRGB(255, 255, 255)
tutorialkeyStroke.Parent = tutorialkey

tutorialKeyPadding.Parent = tutorialkey
tutorialKeyPadding.PaddingBottom = UDim.new(0.200000003, 0)
tutorialKeyPadding.PaddingLeft = UDim.new(0.200000003, 0)
tutorialKeyPadding.PaddingRight = UDim.new(0.200000003, 0)
tutorialKeyPadding.PaddingTop = UDim.new(0.200000003, 0)
